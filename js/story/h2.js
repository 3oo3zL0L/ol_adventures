  ...
  steps: [
    ...
    // --- Praatpuzzel 1: getuige Brom ---
    {
      ...
      intents: [
        ...
        { id: 'eten', keys: ['wat zat erin', 'wat zat er in', 'eten', 'opeten', 'eet je', 'lekker', 'eetbaar', 'smaakt', 'proeven', 'bijten', 'kauwen'],
        ...
        { id: 'ruikt', keys: ['ruikt het lekker', 'ruikt', 'ruiken', 'geur', 'stinkt', 'stinken', 'ruik'],
    ...
    // --- Praatpuzzel 2: getuige Kwebbel ---
    {
      ...
      intents: [
        ...
        { id: 'bijna', keys: ['zebra', 'zebraatje', 'tijger', 'tijgertje', 'pyjama'],
          a: 'Een zebra of een tijger? Die wonen hier niet! Maar zijn staart leek er wel op, als je goed ziet.', a2: 'Zo groot als een tijger was hij niet, o nee. Maar zijn staart leek erop, denk maar mee!' },
